<script>
import fecha from 'kerui-element/src/utils/date';
import { range as rangeArr, getFirstDayOfMonth, getPrevMonthLastDays, getMonthDays, getI18nSettings, validateRangeInOneMonth } from 'kerui-element/src/utils/date-util';
