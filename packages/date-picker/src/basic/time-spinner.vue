...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'kerui-element/src/utils/date-util';
  import ElScrollbar from 'kerui-element/packages/scrollbar';
  import RepeatClick from 'kerui-element/src/directives/repeat-click';
